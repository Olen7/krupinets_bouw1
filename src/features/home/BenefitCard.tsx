...
export function BenefitCard({ icon, label }: BenefitCardProps) {
  return (
    <li className="flex flex-col items-center gap-3 rounded border border-orange p-6 text-center transition-colors hover:bg-orange">
      ...
      <p className="font-body text-white">{label}</p>
    </li>
  )
}
